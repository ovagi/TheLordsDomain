package com.github.ovagi.lordsDomain.robovm;
...
public class LordsDomainRoboVM extends UIApplicationDelegateAdapter {
  ...
  public static void main (String[] args) {
    ...
    UIApplication.main(args, null, LordsDomainRoboVM.class);
    pool.close();
  }
}
